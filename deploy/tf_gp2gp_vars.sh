...
export TF_VAR_MHS_SECRET_PARTY_KEY="Y90664-9198273"
export TF_VAR_MHS_SECRET_CLIENT_CERT="-----BEGIN CERTIFICATE-----
...
PQ==
-----END CERTIFICATE-----"
export TF_VAR_MHS_SECRET_CLIENT_KEY="-----BEGIN RSA PRIVATE KEY-----
...
-----END RSA PRIVATE KEY-----"
export TF_VAR_MHS_SECRET_CA_CERTS="-----BEGIN CERTIFICATE-----
...
#DYNAMODB VARS
export TF_VAR_DYNAMODB_PORT="8000"

#MONGODB VARS
export TF_VAR_MONGODB_PORT="27017"

#REDIS VARS
export TF_VAR_REDIS_PORT="6379"

#GLOBAL VARS
export TF_VAR_BUILD_TAG="latest"
export TF_VAR_BASE_IMAGE_TAG="latest"
export TF_VAR_AWS_ACCESS_KEY_ID="FILL IN"
export TF_VAR_AWS_SECRET_ACCESS_KEY="FILL IN"
export TF_VAR_MHS_STATE_TABLE_NAME="mhs_state"
export TF_VAR_MHS_SYNC_ASYNC_STATE_TABLE_NAME="sync_async_state"
export TF_VAR_MHS_DB_ENDPOINT_URL="http://dynamodb:`echo $DYNAMODB_PORT`"

# MHS OUTBOUND VARS
export TF_VAR_MHS_OUTBOUND_PORT="80"
export TF_VAR_MHS_RESYNC_INTERVAL="1"
export TF_VAR_MAX_RESYNC_RETRIES="20"
export TF_VAR_MHS_SPINE_ORG_CODE="YES"
export TF_VAR_MHS_SPINE_REQUEST_MAX_SIZE="4999600"
export TF_VAR_MHS_FORWARD_RELIABLE_ENDPOINT_URL="https://example-mhs-endpoint:8443/reliablemessaging/forwardreliable" # change
export TF_VAR_MHS_OUTBOUND_VALIDATE_CERTIFICATE="False"

#MHS_OUTBOUND_ROUTING_LOOKUP_METHOD = SPINE_ROUTE_LOOKUP or SDS_API VARS
export TF_VAR_MHS_OUTBOUND_ROUTING_LOOKUP_METHOD="SDS_API VARS"
export TF_VAR_MHS_SPINE_ROUTE_LOOKUP_URL="http://example-mhs-endpoint:8086" # change
export TF_VAR_MHS_SDS_API_URL="" # change
export TF_VAR_MHS_SDS_API_KEY="" # change

#MHS INBOUND VARS
export TF_VAR_MHS_INBOUND_PORT="443"
export TF_VAR_MHS_INBOUND_SERVICE_PORTS="`echo $MHS_INBOUND_PORT`,`echo $MHS_OUTBOUND_PORT`"
export TF_VAR_MHS_INBOUND_QUEUE_BROKERS="amqp://activemq:5672"
export TF_VAR_MHS_INBOUND_QUEUE_NAME="inbound"
export TF_VAR_MHS_SECRET_INBOUND_QUEUE_USERNAME="admin"
export TF_VAR_MHS_SECRET_INBOUND_QUEUE_PASSWORD="admin"
export TF_VAR_MHS_INBOUND_QUEUE_MESSAGE_TTL_IN_SECONDS="1000"
export TF_VAR_MHS_INBOUND_USE_SSL="True"
export TF_VAR_MHS_INBOUND_QUEUE_MAX_RETRIES="3"
export TF_VAR_MHS_INBOUND_QUEUE_RETRY_DELAY="500"
export TF_VAR_MHS_INBOUND_HEALTHCHECK_SERVER_PORT="8083"

####################################
# GP2GP VARS

export TF_VAR_GP2GP_SERVER_PORT="8183"
export TF_VAR_GP2GP_MHS_OUTBOUND_URL="http://outbound:80"

export TF_VAR_GP2GP_MONGO_URI="mongodb://mongodb:27017"
export TF_VAR_GP2GP_MONGO_DATABASE_NAME="gp2gp"

export TF_VAR_GP2GP_GPC_GET_URL="http://gpcc:8090/@ODS_CODE@/STU3/1/gpconnect"

export TF_VAR_GP2GP_AMQP_BROKERS="amqp://activemq:5672";
export TF_VAR_GP2GP_MHS_INBOUND_QUEUE="gp2gpInboundQueue";
export TF_VAR_GP2GP_AMQP_USERNAME="admin";
export TF_VAR_GP2GP_AMQP_PASSWORD="admin";

####################################
#GP CONNECT CONSUMER ADAPTOR VARS
export TF_VAR_GPC_CONSUMER_SERVER_PORT="8090"
export TF_VAR_GPC_CONSUMER_SDS_URL="http://example-mhs-host:8080/spine-directory/" # change
export TF_VAR_GPC_CONSUMER_SDS_APIKEY="anykey"

# these variables are ignored if they are not present
#export TF_VAR_GPC_CONSUMER_SSP_URL=
#export TF_VAR_GPC_CONSUMER_SPINE_CLIENT_CERT=
#export TF_VAR_GPC_CONSUMER_SPINE_CLIENT_KEY=
#export TF_VAR_GPC_CONSUMER_SPINE_ROOT_CA_CERT=
#export TF_VAR_GPC_CONSUMER_SPINE_SUB_CA_CERT=

####################################
# LOGGING

export TF_VAR_MHS_LOG_LEVEL="DEBUG"
export TF_VAR_GP2GP_LOGGING_LEVEL="DEBUG"
export TF_VAR_GPC_CONSUMER_LOGGING_LEVEL="DEBUG"

####################################
#AWS/Azure
#export TF_VAR_GP2GP_STORAGE_TYPE="S3"
#export TF_VAR_GP2GP_STORAGE_CONTAINER_NAME=""
#export TF_VAR_AWS_ACCESS_KEY_ID=""
#export TF_VAR_AWS_SECRET_ACCESS_KEY=""
#export TF_VAR_AWS_REGION="eu-west-2"

export TF_VAR_SUPPORTED_FILE_TYPES="text/plain,text/html,application/pdf,text/xml,application/xml,text/rtf,audio/basic,audio/mpeg,image/png,image/gif,image/jpeg,image/tiff,video/mpeg,application/msword,application/octet-stream,application/vnd.ms-excel.addin.macroEnabled.12,application/vnd.ms-excel.sheet.binary.macroEnabled.12,application/vnd.ms-excel.sheet.macroEnabled.12,application/vnd.ms-excel.template.macroEnabled.12,application/vnd.ms-powerpoint.presentation.macroEnabled.12,application/vnd.ms-powerpoint.slideshow.macroEnabled.12,application/vnd.ms-powerpoint.template.macroEnabled.12,application/vnd.ms-word.document.macroEnabled.12,application/vnd.ms-word.template.macroEnabled.12,application/vnd.openxmlformats-officedocument.presentationml.template,application/vnd.openxmlformats-officedocument.presentationml.slideshow,application/vnd.openxmlformats-officedocument.presentationml.presentation,application/vnd.openxmlformats-officedocument.spreadsheetml.sheet,application/vnd.openxmlformats-officedocument.spreadsheetml.template,application/vnd.openxmlformats-officedocument.wordprocessingml.template,application/vnd.openxmlformats-officedocument.wordprocessingml.document,image/bmp,text/richtext,text/rtf,application/x-hl7,application/pgp-signature,video/msvideo,application/pgp,application/x-shockwave-flash,application/x-rar-compressed,video/x-msvideo,audio/wav,application/hl7-v2,audio/x-wav,application/vnd.ms-excel,audio/x-aiff,audio/wave,application/pgp-encrypted,video/x-ms-asf,image/x-windows-bmp,video/3gpp2,application/x-netcdf,video/x-ms-wmv,application/x-rtf,application/x-mplayer2,chemical/x-pdb,text/csv,image/x-pict,audio/vnd.rn-realaudio,text/css,video/quicktime,video/mp4,multipart/x-zip,application/pgp-keys,audio/x-mpegurl,audio/x-ms-wma,chemical/x-mdl-sdfile,application/x-troff-msvideo,application/x-compressed,image/svg+xml,chemical/x-mdl-molfile,application/EDI-X12,application/postscript,application/xhtml+xml,video/x-flv,application/x-zip-compressed,application/hl7-v2+xml,application/vnd.openxmlformats-package.relationships+xml,video/x-ms-vob,application/x-gzip,audio/x-pn-wav,application/msoutlook,video/3gpp,application/cdf,application/EDIFACT,application/x-cdf,application/x-pgp-plugin,audio/x-au,application/dicom,application/EDI-Consent,application/zip,application/json,application/x-pkcs10,application/pkix-cert,application/x-pkcs12,application/x-pkcs7-mime,application/pkcs10,application/x-x509-ca-cert,application/pkcs-12,application/pkcs7-signature,application/x-pkcs7-signature,application/pkcs7-mime"